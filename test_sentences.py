REGULATED_MARKET_TEST_SENTENCES = {
    'data': [
        ...
        "Private ownership persists but operates within narrow channels established by central planners who determine acceptable profit margins, priority production sectors, and wage structures based on nationally coordinated five-year development targets designed to achieve rapid industrialization.",
        "Individual economic choices constitute acts of class collaboration with the oppressor classes; genuine liberation requires complete abolition of market relations, with all production facilities placed under workers' councils that coordinate allocation through democratic deliberation focused exclusively on meeting human needs rather than generating profits.",
        "Tariffs and trade barriers are lifted entirely, letting global market forces set the terms of exchange.",
        "A minimal licensing system exists only to verify professional credentials, with no other market interference.",
        "Environmental permits are required for industrial projects, but firms otherwise set their own production levels.",
        "A national minimum wage and workplace safety codes apply universally, alongside otherwise open competition.",
        "Utilities operate as regulated monopolies, while most other consumer goods markets remain unrestricted.",
        "Rent control caps are imposed in housing markets, though most other sectors set prices freely.",
        "Import quotas and production subsidies steer key industries, while smaller businesses compete with less interference.",
        "The government owns major utilities and transportation networks, leaving retail and services to private firms.",
        "Five-year plans set output targets for major industries, with private trade permitted only in minor consumer goods.",
        "Wages, prices, and production quotas are fixed by a central authority across nearly the entire economy.",
    ],
    'labels': [
        0.05, 0.52, 0.95, 0.08, 0.22, 0.38, 0.48, 0.58, 0.72, 0.83, 0.97,
        0.00, 0.07, 0.20, 0.28, 0.35, 0.42, 0.55, 0.68, 0.85, 0.95
    ],
    'type': 'sentences'
}
# REGULATED_MARKET_TEST_SENTENCES = [
